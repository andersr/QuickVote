...
Meteor.methods({
  ...
  newUserVote:function(voteChoiceId){
    ...
    //get the voteId
    // pass this set hasVotes true - only once
    // elsewhere - check for winner
    //push this voteChoiceId to winningVotes
  ...
  toggleUpDownVote:function(userVoteAttributes){
    ...
    //has this user voted on another voteChoice with this voteId?
    // if yes downVote that vote when upvoting this vote
